    ...
    <div class="entity_wrapper">
        <div class="entity_title header_purple">
            <h1>
                ...
                <router-link :to="{name: 'tagArticle', params: {slug: tag.slug}}">
                    <a>{{ tag.name }}</a>
                </router-link>
            </h1>
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            getData(page) {
                ...
                axios.get('/api/v1/app-tag-articles/' + slug + '?page='+page)
                .then(function (resp) {
                    // console.log(resp.data);
                    app.rows = resp.data.tag_articles.data;
                    app.pagination = resp.data.tag_articles;
                    app.tag = resp.data.tag;
                    app.rowFirst = resp.data.tag_articles.data[0];
