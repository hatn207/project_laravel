...
<div class="row">
    ...
    <div class="entity_wrapper">
        ...
        <div class="entity_thumb">
            <img class="img-responsive" src="app/assets/img/category_img_top.jpg" alt="feature-top">
        </div>
        <!-- entity_thumb -->
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="category_article_body">
                <div class="top_article_img">
                    <img class="img-fluid" src="app/assets/img/category_img1.jpg" alt="feature-top">
                </div>
                <!-- top_article_img -->
        ...
        <div class="col-md-6">
            <div class="category_article_body">
                <div class="top_article_img">
                    <img class="img-responsive" src="app/assets/img/category_img2.jpg" alt="feature-top">
                </div>
                <!-- top_article_img -->
    ...
    <div class="widget_advertisement">
        <img class="img-responsive" src="app/assets/img/category_advertisement.jpg" alt="feature-top">
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="category_article_body">
                <div class="top_article_img">
                    <img class="img-responsive" src="app/assets/img/category_img3.jpg" alt="feature-top">
                </div>
                <!-- row -->
        ...
        <div class="col-md-6">
            <div class="category_article_body">
                <div class="top_article_img">
                    <img class="img-responsive" src="app/assets/img/category_img4.jpg" alt="feature-top">
                </div>
                <!-- top_article_img -->
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="category_article_body">
                <div class="top_article_img">
                    <img class="img-responsive" src="app/assets/img/category_img5.jpg" alt="feature-top">
                </div>
                <!-- top_article_img -->
        ...
        <div class="col-md-6">
            <div class="category_article_body">
                <div class="top_article_img">
                    <img class="img-responsive" src="app/assets/img/category_img6.jpg" alt="feature-top">
                </div>
                <!-- top_article_img -->
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="category_article_body">
                <div class="top_article_img">
                    <img class="img-responsive" src="app/assets/img/category_img7.jpg" alt="feature-top">
                </div>
                <!-- top_article_img -->
        ...
        <div class="col-md-6">
            <div class="category_article_body">
                <div class="top_article_img">
                    <img class="img-responsive" src="app/assets/img/category_img8.jpg" alt="feature-top">
                </div>
                <!-- top_article_img -->
    ...
    <div class="widget">
        ...
        <div class="media">
            <div class="media-left">
                <a href="#"><img class="media-object" src="app/assets/img/pop_right1.jpg" alt="Generic placeholder image"></a>
            </div>
        ...
        <div class="media">
            <div class="media-left">
                <a href="#"><img class="media-object" src="app/assets/img/pop_right2.jpg" alt="Generic placeholder image"></a>
            </div>
            <div class="media-body">
                <h3 class="media-heading">
        ...
        <div class="media">
            <div class="media-left">
                <a href="#"><img class="media-object" src="app/assets/img/pop_right3.jpg" alt="Generic placeholder image"></a>
            </div>
            <div class="media-body">
                <h3 class="media-heading">
        ...
        <div class="media">
            <div class="media-left">
                <a href="#"><img class="media-object" src="app/assets/img/pop_right4.jpg" alt="Generic placeholder image"></a>
            </div>
            <div class="media-body">
                <h3 class="media-heading">
    ...
    <div class="widget hidden-xs m30">
        <img class="img-responsive adv_img" src="app/assets/img/right_add1.jpg" alt="add_one">
        <img class="img-responsive adv_img" src="app/assets/img/right_add2.jpg" alt="add_one">
        <img class="img-responsive adv_img" src="app/assets/img/right_add3.jpg" alt="add_one">
        <img class="img-responsive adv_img" src="app/assets/img/right_add4.jpg" alt="add_one">
    </div>
    <!-- Advertisement -->
    
    <div class="widget hidden-xs m30">
        <img class="img-responsive widget_img" src="app/assets/img/right_add5.jpg" alt="add_one">
    </div>
    <!-- Advertisement -->
    ...
    <div class="widget hidden-xs m30">
        <img class="img-responsive widget_img" src="app/assets/img/right_add6.jpg" alt="add_one">
    </div>
    <!-- Advertisement -->
    ...
    <div class="widget m30">
        ...
        <div class="widget_body"><img class="img-responsive left" src="app/assets/img/editor.jpg"
    ...
    <div class="widget hidden-xs m30">
        <img class="img-responsive add_img" src="app/assets/img/right_add7.jpg" alt="add_one">
        <img class="img-responsive add_img" src="app/assets/img/right_add7.jpg" alt="add_one">
        <img class="img-responsive add_img" src="app/assets/img/right_add7.jpg" alt="add_one">
        <img class="img-responsive add_img" src="app/assets/img/right_add7.jpg" alt="add_one">
    </div>
    ...
    <div class="widget m30">
        ...
        <div class="widget_body"><img class="img-responsive left" src="app/assets/img/reader.jpg"
                                        alt="Generic placeholder image">
    ...
    <div class="widget hidden-xs m30">
        <img class="img-responsive widget_img" src="app/assets/img/podcast.jpg" alt="add_one">
    </div>
    <!--Advertisement-->
    </div>
    <!-- col-md-4 -->
